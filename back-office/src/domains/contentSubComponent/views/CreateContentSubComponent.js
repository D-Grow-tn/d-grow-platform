...
function CreateContentSubComponent() {
    ...
    console.log("🚀 ~ file: CreateContentSubComponent.js:13 ~ CreateContentSubComponent ~ contentsubComponet:", contentsubComponet)
    const [inputs, setInputs] = useState([]);
    const contentsubcomponets = useSelector(
      (state) => state.contentsubcomponet.contentsubcomponets.items
    );
    console.log("🚀 ~ file: CreateContentSubComponent.js:15 ~ CreateContentSubComponent ~ contentsubcomponets:", contentsubcomponets)
    useEffect(() => {
        setInputs([
          {
            label: "Title",
