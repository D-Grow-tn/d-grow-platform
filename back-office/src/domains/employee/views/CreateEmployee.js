  ...
  return (
    <div>
     ...
     <div className="py-5">
      ...
      <div className="d-flex align-items-center justify-content-around px-5 gap-5 p-3 ">
          <TextInput Placeholder="First Name" width="300px" />
          <TextInput Placeholder="Last Name" width="300px" />
        </div>

      <TextInput Placeholder="Adress" width="500px" />
    </div>
  )
}
