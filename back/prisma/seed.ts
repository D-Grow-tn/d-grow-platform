...
async function main() {
  ...
  let mainComponent1 = await prisma.mainComponent.create({
    data:{
      title: "Footer",
    path: "/footer",
    type: "footer",
  ...
  let mainComponent2 = await prisma.mainComponent.create({
    data:  {
      title: "Header",
      path: "/header",
      type: "header",
  ...
  let mainComponent3 = await prisma.mainComponent.create({
    data:  {
      title: "Sidebar",
      path: "/sidebar",
      type: "sidebar",
  ...
  let mainComponent4 = await prisma.mainComponent.create({
    data:  {
      title: "Page",
      path: "/page",
      type: "page",
  ...
  let subComponent1 = await prisma.subComponent.create({
    data:{
      name:"Left SubComponent",
      mainId:mainComponent1.id,
      position: "left",
    }
  }) 

  let subComponent2 = await prisma.subComponent.create({
    data:{
      name:"right SubComponent",
      mainId:mainComponent1.id,
      position: "right",
    }
  }) 

  let subComponent3 = await prisma.subComponent.create({
    data:{
      name:"top SubComponent",
      mainId:mainComponent1.id,
      position: "top",
    }
  }) 

  let subComponent4= await prisma.subComponent.create({
    data:{
      name:"middel SubComponent",
      mainId:mainComponent1.id,
      position: "middle",
    }
  }) 
  let subComponent5= await prisma.subComponent.create({
    data:{
      name:"bottom SubComponent",
      mainId:mainComponent1.id,
      position: "bottom",
    }
  })
...
//create subcomponent header
  let subComponent6 = await prisma.subComponent.create({
    data:{
      name:"Left SubComponent",
      mainId:mainComponent2.id,
      position: "left",
    }
  }) 

  let subComponent7 = await prisma.subComponent.create({
    data:{
      name:"right SubComponent",
      mainId:mainComponent2.id,
      position: "right",
  ...
  let subComponent8 = await prisma.subComponent.create({
    data:{
      name:"middle SubComponent",
      mainId:mainComponent2.id,
      position: "middle",
    }
  }) 
...
//create subComponent sidebar
  ...
  let subComponent9= await prisma.subComponent.create({
    data:{
      name:"top SubComponent",
      mainId:mainComponent3.id,
      position: "top",
    }
  })

  let subComponent10 = await prisma.subComponent.create({
    data:{
      name:"middleSubComponent",
      mainId:mainComponent3.id,
      position: "middle",
    }
  })

  let subComponent11 = await prisma.subComponent.create({
    data:{
      name:"bottomSubComponent",
      mainId:mainComponent3.id,
      position: "bottom",
    }
  })
...
let subComponent12 = await prisma.subComponent.create({
  data:{
    name:"Left SubComponent",
    mainId:mainComponent4.id,
    position: "left",
  }
}) 

let subComponent13 = await prisma.subComponent.create({
  data:{
    name:"right SubComponent",
    mainId:mainComponent4.id,
    position: "right",
...
let subComponent14= await prisma.subComponent.create({
  data:{
    name:"top SubComponent",
    mainId:mainComponent4.id,
    position: "top",
...
let subComponent15 = await prisma.subComponent.create({
  data:{
    name:"middleSubComponent",
    mainId:mainComponent4.id,
    position: "middle",
...
let subComponent16 = await prisma.subComponent.create({
  data:{
    name:"section SubComponent",
    mainId:mainComponent4.id,
    position: "section",
  }
})

let subComponent17 = await prisma.subComponent.create({
  data:{
    name:"bottomSubComponent",
    mainId:mainComponent4.id,
    position: "bottom",
...
//create all content sub component
  ...
  let contentSubComponents1 =await prisma.contentSubComponent.create({
    data:{
      ...
      subComponentId: subComponent4.id, 
  }
})


let contentSubComponents2 =await prisma.contentSubComponent.create({
  data:{
    title: "image",
    navigateTo: "",
    content: "image",
    subComponentId: subComponent3.id, 
}
})


let contentSubComponents3 =await prisma.contentSubComponent.create({
  data:{
    title: "button",
    navigateTo: "/page",
    content: "Show more",
    subComponentId: subComponent1.id, 
}
})
}
