...
export default function App() {
  return (
    <div style={{ minHeight: '60vh', position: 'relative',backgroundColor: "#070f4e",marginTop:"50px" }}> 
    <MDBFooter className='text-center text-lg-start text-muted'    style={{ position: 'absolute', bottom: 0, width: '100%',backgroundColor: "#070f4e" }}>
      ...
      <section className=''>
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md="3" lg="4" xl="3" className='mx-auto mb-4' style={{color:"white"}}>
              <h6 className='text-uppercase fw-bold mb-4'>
                <MDBIcon icon="gem" className="me-3" style={{color:"white"}} />
                D-Grow
              </h6>
              <p>
              "Unleash Your Digital Growth with D-Grow: Crafting Exceptional Web and Mobile Experiences"
              </p>
            </MDBCol>
      ...
      <div className='text-center p-4' style={{ backgroundColor: "#070f4e" ,color:"white" }}>
