...
function Home() {
 ...
 <dl>
        ...
        <div className="container " style={{paddingTop:"150px"}}>
          <div className="row content ">
            ...
            >
              ...
              >
                {titleSection2?.map((e)=>(e?.content[0]))} <spann style={{color:"#00ac9e"}}>{titleSection2?.map((e)=>(e?.content[2]))}</spann> {titleSection2?.map((e)=>(e?.content[2]))}
              </h2>
            ...
            <p> we pride ourselves on delivering high-quality solutions that combine cutting-edge technology, aesthetic design, and user-centric functionality.</p>
  ...
  // className="dark-bleu"
   ...
   {titleSection3?.map((e)=>(e?.content))}</h1>
...
<div className="card-hover" key={i} style={{ width:"350px"}}>
  <div className="card-hover__content">
    ...
    <a href="" className="card-hover__link">
      <span  onClick={() => navigate(`/applications/${project.id}`)}>Learn more</span>
      <svg
        fill="none"
        viewBox="0 0 24 24"
        strokeWidth="1.5"
