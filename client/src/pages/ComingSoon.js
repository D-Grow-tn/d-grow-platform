    ...
    <div className='body'>
      <div id="header" className="d-flex align-items-center">
        ...
        <div className="container d-flex flex-column align-items-center">
          ...
          <div className="countdown d-flex justify-content-center" data-count="2023/12/5">
            <div>
              <h3>{day}</h3>
              <h4>Days</h4>
            </div>
          ...
          <div className="container">
            <div className="row content">
              <div className="col-lg-6">
                <h2>D-Grow</h2>
                <h3>Empowering businesses with stunning websites and engaging mobile applications for a strong digital presence</h3>
              </div>
              <div className="col-lg-6 pt-4 pt-lg-0">
               ...
               D-Grow is a leading provider of innovative digital solutions, specializing in the development of websites and mobile applications. With a team of highly skilled professionals and a wealth of industry expertise, we offer comprehensive services to help businesses establish a strong online presence and drive their success in the digital realm.
                ...
                we pride ourselves on delivering high-quality solutions that combine cutting-edge technology, aesthetic design, and user-centric functionality. Our commitment to excellence, attention to detail, and collaborative approach make us the preferred choice for businesses looking to enhance their online presence and engage with their audience effectively.
                </p>
              </div>
            </div>
          </div>
