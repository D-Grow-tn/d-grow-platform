    ...
    objectives: [
      ...
      },
      {
        ...
        subobjects: [
          ...
          { name: "App Store Submission", status: "Not started" },
        ],
      },
    ],
  },
  ...
  contract: "ABC-123",
    ...
    objectives: [
      ...
      },
      {
        ...
        status: "Completed",
        subobjects: [
          { name: "Functional Testing", status: "Completed" },
          { name: "Deployment to Production", status: "Completed" },
        ],
      },
    ],
  },
    ...
    objectives: [
      {
        ...
        status: "In progress",
        subobjects: [
          { name: "Database Design", status: "In progress" },
      ...
      },
      {
        ...
        status: "Not started",
        subobjects: [
          { name: "UI Mockup", status: "Not started" },
